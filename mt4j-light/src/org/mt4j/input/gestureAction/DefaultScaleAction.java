...
//	 */
//	public DefaultScaleAction(AbstractMTLayer<?> customTarget){
...
//	 * @param maxScaleFactor the max scale factor
//	 */
//	public DefaultScaleAction(AbstractMTLayer<?> customTarget, float minScaleFactor, float maxScaleFactor){
...
//	 */
//	private DefaultScaleAction(AbstractMTLayer<?> customTarget, float minScaleFactor, float maxScaleFactor, boolean useScaleLimit){
...
//
//
//	protected void doAction(AbstractMTLayer<?> target, ScaleEvent se) {
//		if(!gestureAborted)
//		{
