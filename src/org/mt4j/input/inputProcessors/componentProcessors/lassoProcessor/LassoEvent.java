...
//	 */
//	public LassoEvent(IInputProcessor source, int id, AbstractMTLayer<?> targetComponent, InputCursor motion, MTPolygon selectionPoly, ILassoable[] selectedComponents) {
